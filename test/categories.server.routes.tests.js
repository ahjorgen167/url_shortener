...
var should = require('should'),
	...
	app = require('../../server/model/url/url.schema.server'),
	api = require('./models.server.routes.tests.api')(app, 'URL', '/api/shorten/'),
 ...
 * Unit tests
 */
describe('URL API Testing', function() {
	before(function(done) {
		var url = new URL({
	    _id: 1,
  	  decoded_url: "https://test",
		});
		url.save(done);
	});
	after(function(done) {
